          ...
          <div className="row justify-content-center">
            <div className="col-xl-5 col-lg-7 col-md-9 col-sm-11">
              <div className="footer__info text-center">
                ...
                <p>
                 We simplify the way you Send, Trade, and Manage your Crypto, Fiat, and OBB Tokens. Experience the Bore Ecosystem today.
                </p>
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="copyright__text">
                  <p>&copy; {new Date().getFullYear()} Bores. All rights reserved.</p>
                </div>
              </div>
              <div className="col-md-6">
