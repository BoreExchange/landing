          ...
          <div className="row">
            <div className="col-lg-6">
              ...
              >
                ...
                <h2 className="title">Empower Your Financial Freedom</h2>
                <p className="desc">
            ...
            <div className="col-lg-6">
              ...
              >
                ...
                <div className="banner__images-grid">
                  <div className="left">
                    <img src="/assets/img/artwork/05.png" alt="artworks" />
                  </div>
                  <div className="right">
                    <img src="/assets/img/artwork/13.png" alt="artworks" />
                  </div>
                </div>
